...
<body class="font-sans antialiased dark:bg-black dark:text-white/50">
    <div class="bg-gray-50 text-black/50 dark:bg-black dark:text-white/50">
        <img id="background" class="absolute left-0 top-0"
        src="{{ Vite::asset('resources/images/gradient-bg.jpg') }}" alt="New Background" />
        <div
                                ...
                                <x-dropdown align="right" width="48">
                                    <x-slot name="trigger">
                                        <button
                                            ...
                                            <div>{{ strtoupper(session('locale', 'pt')) }}</div>
                                            <div class="ms-1">
                                    ...
                                    <x-slot name="content">
                                        <!-- Link to switch to English -->
                                        <x-dropdown-link :href="route('lang.switch', ['locale' => 'en'])">
                                            {{ __('English') }}
                                        </x-dropdown-link>
                                        <!-- Link to switch to Portuguese -->
                                        <x-dropdown-link :href="route('lang.switch', ['locale' => 'pt'])">
                                            {{ __('Português') }}
                                        </x-dropdown-link>
                                    </x-slot>
                                </x-dropdown>
